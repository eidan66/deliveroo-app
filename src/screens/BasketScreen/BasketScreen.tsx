...
import { BasketNavigationType } from '../../types/navigation';

type GroupedItem = { [key: string]: DishRow[] };

export const BasketScreen = () => {
  const navigation = useNavigation<BasketNavigationType>();
  ...
  const [groupedItemInBasket, setGroupedItemInBasket] = useState<GroupedItem>(
    {}
  );

  useMemo(() => {
    const groupedItems = items.reduce<GroupedItem>((results, item) => {
